  ...
  return (
    ...
    >
      ...
      <div className="holistic-inner">
        ...
        >
          <p className="holistic-eyebrow">Our Holistic Approach to Learning</p>
          ...
          <p className="holistic-text">
            At Saudi-Canadian Training & Simulation Center, we go beyond traditional teaching methods to deliver a truly comprehensive medical education experience. Our holistic approach seamlessly blends strong theoretical foundations with immersive practical application — cultivating critical thinking, refined clinical judgment, and compassionate patient care.
          </p>
          <p className="holistic-text">
